...
class ActivityIntroduceView: UIView {

    // MARK: Variables
    
    static let id = "activityIntroduceView"
...
@available(iOS 13.0, *)
struct ActivityIntroduceView_Preview: PreviewProvider {
    static var previews: some View {
        UIViewPreview {
            let button = ActivityIntroduceView()
            return button
        }
